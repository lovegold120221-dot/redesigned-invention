...
const LANGUAGES = [
  ...
  { code: 'he', name: 'Hebrew' }, { code: 'id', name: 'Indonesian' },
  ...
  { code: 'mt', name: 'Maltese' }, { code: 'ga', name: 'Irish' },
  { code: 'cy', name: 'Welsh' }, { code: 'sq', name: 'Albanian' },
  ...
  { code: 'ceb', name: 'Cebuano' }, { code: 'co', name: 'Corsican' },
  { code: 'eo', name: 'Esperanto' }, { code: 'gl', name: 'Galician' },
  { code: 'ka', name: 'Georgian' }, { code: 'ha', name: 'Hausa' },
  { code: 'haw', name: 'Hawaiian' }, { code: 'hmn', name: 'Hmong' },
  { code: 'ig', name: 'Igbo' }, { code: 'jw', name: 'Javanese' },
  { code: 'kk', name: 'Kazakh' }, { code: 'km', name: 'Khmer' },
  { code: 'rw', name: 'Kinyarwanda' }, { code: 'ku', name: 'Kurdish' },
  ...
  { code: 'mg', name: 'Malagasy' }, { code: 'sm', name: 'Samoan' },
  { code: 'sn', name: 'Shona' }, { code: 'tt', name: 'Tatar' },
  { code: 'wo', name: 'Wolof' },
];
